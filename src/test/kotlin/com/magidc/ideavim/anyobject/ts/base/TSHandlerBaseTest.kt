...
//    }
    ...
    open fun testCpp() = doTestLanguageHandler("cpp.json")
    open fun testCsharp() = doTestLanguageHandler("csharp.json")
    open fun testGo() = doTestLanguageHandler("go.json")
    ...
    open fun testDart() = doTestLanguageHandler("dart.json")
    open fun testR() = doTestLanguageHandler("r.json")
    open fun testRuby() = doTestLanguageHandler("ruby.json")
    open fun testRust() = doTestLanguageHandler("rust.json")
    open fun testScala() = doTestLanguageHandler("scala.json")
    open fun testSwift() = doTestLanguageHandler("swift.json")
    open fun testTypescript() = doTestLanguageHandler("typescript.json")
    open fun testJson() = doTestLanguageHandler("json.json")
    open fun testYaml() = doTestLanguageHandler("yaml.json")
}