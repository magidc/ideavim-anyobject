...
class TSLanguageUtils {
    ...
    companion object {
        ...
        private val languageMap: Map<String, TSLanguageInfo> = mapOf(
            "JAVA" to TSLanguageInfo("JAVA", "intellij", { TreeSitterJava() }, setOf("java"), TSBlockType.BRACES),
            ...
            "RUBY" to TSLanguageInfo("RUBY", "rubymine", { TreeSitterRuby() }, setOf("rb"), TSBlockType.END),
            "GO" to TSLanguageInfo("GO", "goland", { TreeSitterGo() }, setOf("go"), TSBlockType.BRACES),
            "PYTHON" to TSLanguageInfo("PYTHON", "pycharm", { TreeSitterPython() }, setOf("py"), TSBlockType.INDENTED),
            "PHP" to TSLanguageInfo("PHP", "phpstorm", { TreeSitterPhp() }, setOf("php"), TSBlockType.BRACES),
            ...
            "C/C++" to TSLanguageInfo("C/C++", "clion", { TreeSitterCpp() }, setOf("cpp"), TSBlockType.BRACES),
