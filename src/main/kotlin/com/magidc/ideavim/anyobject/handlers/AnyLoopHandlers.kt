...
private class AnyLoopHandler(isInner: Boolean) : AbstractPSIBasedHandler(isInner) {
    companion object {
        private val languageLoopTypes = mapOf(
            "JAVA" to setOf("FOR_STATEMENT", "WHILE_STATEMENT", "DO_WHILE_STATEMENT", "ENHANCED_FOR_STATEMENT"),
            ...
            "ELIXIR" to setOf("FOR", "WHILE", "FOR_COMPREHENSION", "ENUM_EACH"),
            ...
            "CRYSTAL" to setOf("FOR", "WHILE", "UNTIL", "LOOP"),
            "JULIA" to setOf("FOR", "WHILE", "FOR_STATEMENT", "WHILE_STATEMENT"),
            "NIM" to setOf("FOR_STMT", "WHILE_STMT", "FOR", "WHILE"),
            "ZIG" to setOf("FOR", "WHILE", "FOR_STATEMENT", "WHILE_STATEMENT"),
            "ODIN" to setOf("FOR", "FOR_STATEMENT", "WHILE_STATEMENT"),
            "D" to setOf("FOR_STATEMENT", "WHILE_STATEMENT", "DO_WHILE_STATEMENT", "FOREACH_STATEMENT"),
            "PASCAL" to setOf("FOR_STATEMENT", "WHILE_STATEMENT", "REPEAT_STATEMENT"),
            "FORTRAN" to setOf("DO_LOOP", "WHILE_LOOP", "FOR_LOOP"),
            "COBOL" to setOf("PERFORM_STATEMENT", "PERFORM_UNTIL", "PERFORM_VARYING"),
            "ADA" to setOf("FOR_LOOP", "WHILE_LOOP", "LOOP_STATEMENT")
        )
    }
