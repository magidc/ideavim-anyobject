...
class AnyClassHandler : AbstractTSBasedHandler() {
    override val innerBlockTypes = setOf("class_body", "interface_body", "field_declaration_list", "declaration_list")
    override val targetTypes: Set<String> = setOf(
        "class_declaration", "class_definition", "class_specifier", "interface_declaration", "record_declaration",
