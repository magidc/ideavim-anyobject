...
|---------------------------------------|-----------------------------------------------------------------------------------------|-----------------|---------------|
| **[AnyArgument](#AnyArgument)**       | Function arguments, method parameters, and callable expressions                         | `a`             | ✓             |
| **[AnyFunction](#AnyFunction)**       | Functions, methods, and procedures                                                      | `f`             | x             |
| **[AnyClass](#AnyClass)**             | Class, interface, struct, and similar type definitions                                  | `c`             | x             |
| **[AnyVariable](#AnyVariable)**       | Field/variable declarations and assignments                                             | `v`             | x             |
| **[AnyLoop](#AnyLoop)**               | Loop statements (`for`, `while`, `do`, `repeat`, `until`, `loop`, etc.)                 | `l`             | x             |
| **[AnyConditional](#AnyConditional)** | Conditional statements (`if-else`, `switch`, `try-catch`)                               | `y`             | x             |
| **[AnyItem](#AnyItem)**               | Items within collections, tuples, lists, or arrays                                      | `i`             | ✓             |
| **[AnyArgOrItem](#AnyArgOrItem)**     | Combines objects targeted by AnyArgument and AnyItem                                    | `x`             | ✓             |
| **[AnyQuote](#AnyQuote)**             | Content enclosed between any type of quotes (single, double, backticks)                 | `q`             | ✗             |
| **[AnyString](#AnyString)**           | String content                                                                          | `g`             | ✗             |
| **[AnyBracket](#AnyBracket)**         | Content enclosed between any type of brackets (parentheses, square, curly, angle, etc.) | `o`             | ✗             |
| **[AnySubword](#AnySubword)**         | Words nested in longer words (`camelCase`, `snake_case`, `dash-case`)                   | `u`             | ✓             |
| **[AnyDocument](#AnyDocument)**       | Entire document content                                                                 | `d`             | ✗             |
| **[AnyComment](#AnyComment)**         | Comments across different programming languages (`/* */`, `<!-- -->`, etc.)             | `k`             | ✗             |
| **[AnyIndentBlock](#AnyIndentBlock)** | Code blocks based on indentation levels                                                 | `n`             | ✗             |
